          ...
          <div className="space-y-6">
                      ...
                      {selectedFiles.map((file, index) => (
                        <div key={`${file.name}-${index}`} className="flex items-center justify-between p-3 bg-surface-app rounded-lg">
                          ...
                          <button
                            ...
                            className="ml-3 p-1 hover:bg-red-100 hover:text-red-600 rounded text-text-tertiary"
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                ...
                {!isAdmin && (
                  <div className="text-xs text-text-tertiary bg-surface-2 px-2 py-1 rounded">
                ...
                <div className="space-y-2">
                  {attachments.map((attachment) => (
                    <div key={attachment.id} className="flex items-center justify-between p-3 bg-surface-app rounded-lg">
                      <div className="flex items-center flex-1 min-w-0">
                        <File className="w-5 h-5 text-text-tertiary flex-shrink-0" />
                        <div className="ml-3 flex-1 min-w-0">
                          <p className="text-sm font-medium text-text-primary truncate">
                      ...
                      <div className="flex items-center gap-2 ml-4">
                        <button
                          ...
                          className="p-2 text-accent hover:text-info-strong hover:bg-accent-soft rounded-md"
