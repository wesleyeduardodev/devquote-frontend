  ...
  return (
    <div className={`flex items-center gap-2 ${className}`}>
      ...
      <select
        ...
        className="px-3 w-full py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm bg-white"
      >
