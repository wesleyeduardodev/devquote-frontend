...
/** Componente "thunk" que monta CommandPalette/atalhos depois do AuthProvider + Router. */
                    ...
                    <ProtectedRoute>
                        <Layout>
                            <Routes>
                                ...
                                <Route path="/requesters" element={<ProtectedRoute requiredProfile="ADMIN"><RequesterList/></ProtectedRoute>}/>
                                <Route path="/requesters/create" element={<ProtectedRoute requiredProfile="ADMIN"><RequesterCreate/></ProtectedRoute>}/>
                                <Route path="/requesters/:id/edit" element={<ProtectedRoute requiredProfile="ADMIN"><RequesterEdit/></ProtectedRoute>}/>
                                <Route path="/tasks" element={<ProtectedRoute requiredProfiles={['ADMIN','MANAGER','USER']}><TaskList/></ProtectedRoute>}/>
                                <Route path="/tasks/create" element={<ProtectedRoute requiredProfiles={['ADMIN','MANAGER','USER']}><TaskCreate/></ProtectedRoute>}/>
                                <Route path="/tasks/:id/edit" element={<ProtectedRoute requiredProfiles={['ADMIN','MANAGER','USER']}><TaskEdit/></ProtectedRoute>}/>
                                <Route path="/tasks/:id" element={<ProtectedRoute requiredProfiles={['ADMIN','MANAGER','USER']}><TaskView/></ProtectedRoute>}/>
                    ...
                    <AuthProvider>
                        ...
                        <Toaster
                            ...
                            toastOptions={{
                                ...
                                success: { iconTheme: { primary: 'var(--success-strong)', secondary: 'var(--surface-1)' } },
                                error:   { iconTheme: { primary: 'var(--danger-strong)',  secondary: 'var(--surface-1)' } },
                            }}
                        />
                    </AuthProvider>
                </Router>
