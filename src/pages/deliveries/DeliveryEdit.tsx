...
const DeliveryEdit = () => {
    ...
    // Colunas para o DataTable de quotes (mesmas do Create)
    ...
    // Colunas para o DataTable de projects (mesmas do Create)
    ...
    if (!delivery) {
        return (
            <div className="text-center py-12">
                <h2 className="text-xl font-semibold text-gray-900 mb-2">Entrega não encontrada</h2>
                <p className="text-gray-600 mb-4">A entrega que você está procurando não foi encontrada.</p>
