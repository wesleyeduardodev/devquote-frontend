...
import { ArrowLeft, Search, X, Check, User, Hash, FileText, Calculator, Plus, Filter, Tag } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gray-50 py-4 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto space-y-6">
                ...
                <div className="lg:hidden">
                    <Card className="p-4">
                        <h4 className="font-medium text-gray-900 mb-3">Dicas para Novo Orçamento</h4>
                        <div className="space-y-3 text-sm text-gray-600">
                            <div className="flex items-start gap-3">
                                <FileText className="w-4 h-4 text-blue-500 mt-0.5 flex-shrink-0" />
                                <div>
                                    <strong>Tarefa:</strong> Selecione uma tarefa concluída ou em progresso
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <Calculator className="w-4 h-4 text-green-500 mt-0.5 flex-shrink-0" />
                                <div>
                                    <strong>Valor:</strong> O valor é calculado automaticamente das subtarefas
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <Tag className="w-4 h-4 text-purple-500 mt-0.5 flex-shrink-0" />
                                <div>
                                    <strong>Status:</strong> Defina o status inicial do orçamento
                                </div>
                            </div>
                        </div>
                    </Card>
                        ...
                        <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200 flex-shrink-0">
                            <div>
                                ...
                                <p className="text-xs sm:text-sm text-gray-600 mt-1">
                                    Escolha uma tarefa para criar o orçamento
                                </p>
                            </div>
                            <button
