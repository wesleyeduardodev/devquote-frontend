...
const Dashboard = () => {
  ...
  return (
      <div className="space-y-8">
        ...
        {/* Ações rápidas: Solicitantes, Tarefas, Orçamentos e Entregas */}
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-6">
          ...
          <Card title="Entregas" subtitle="Gerencie as entregas do sistema">
            <div className="space-y-4">
              <div className="text-gray-600">
                {deliveriesLoading ? (
                    <LoadingSpinner size="sm" />
                    ...
                    <div className="space-y-1">
                      <p>{deliveryStats.total} entrega{deliveryStats.total !== 1 ? 's' : ''} cadastrada{deliveryStats.total !== 1 ? 's' : ''}</p>
                      <p>{deliveryStats.approved} aprovada{deliveryStats.approved !== 1 ? 's' : ''}</p>
                    </div>
                )}
              </div>
              <div className="flex space-x-3">
